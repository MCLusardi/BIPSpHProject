#Python code for connecting two Arduinos or DFRduinos to a RasPi
...
#The purpose is to read data from two Arduino Megas or DFRduinos receiving data from any number of sensors 
...
#Once you know the port number and baudrate, you enter them into the serial functions in lines 27, 29
